...
class decision_maker(Node):
    ...
    def __init__(self, publisher_msg, publishing_topic, qos_publisher, rate=10, motion_type=POINT_PLANNER):
        ...
        # NOTE: Not sure what dt to use, assuming it's 1/rate = 0.1s right now
        self.localizer=localization(type=kalmanFilter, dt=1/rate)
    ...
    def timerCallback(self):
        ...
        if self.motion_type == SPIRAL_4TUNE:
            self.linearVelocity += 0.01 if self.linearVelocity < 3.0 else 0.0
